...
<head>
			...
			<div class="container">
				...
				<div id="navbar" class="collapse navbar-collapse">
					<ul class="nav navbar-nav pull-right">
						...
						<li><a href="index.html" class="external">Log out</a></li>
	...
	<form>
					...
					<?php
						$query = "select name,email from details";
						$result = mysql_query($query) or die(mysql_error());
					
						 //$rows=$db->query("select name from details");

						echo "<table border='1' align='center'>";
						echo "<tr><th align='center'>Username</th><th align='center'>Email ID</th></tr>";
						while($row=mysql_fetch_assoc($result)){
							$email=$row['email'];
						  echo "<tr><td align='center'>".$row['name']."</td><td align='center'> <a href='viewalldetail.php?email=$email'>".$email."</a></td><tr>";
						}
