...
$password=$_POST['password'];
 ...
 $sql = "SELECT count(email) FROM info WHERE email='$email'" ;
   ...
   else
   {
	   ...
	   if($name != "" && $gender != "" && $age != "" && $height != "" && $weight != "" && $neck != "" && $waist != "" && $hip != "" && $email != "" && $password != "")
		{
		$result = mysql_query("insert into info values ('$name','$gender','$age','$height','$weight','$neck','$waist','$hip','$email','$password')");
		$result1 = mysql_query("insert into login values ('$email','$password')");
		$result2 = mysql_query("insert into details values ('$email','$bmi','$bf','$fw','$lw','$bmr')");
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Fit$Fab</strong> Sign up Form</h1>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="login-form">
									...
									<div class="form-group">
			                        	...
			                        	<input type="number" name="age" placeholder="Age..." maxlength="3" class="form-username form-control" id="form-username" value="" required>
			                        </div>
									<div class="form-group">
