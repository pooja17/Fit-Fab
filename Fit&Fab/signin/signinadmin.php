...
header("location: http://127.0.0.1/Fit&Fab/admin.html");
}else{
	?>
	<script>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Fit$Fab</strong>ADMIN Login Form</h1>
                  ...
                  <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                        	...
                        	<h2><a href="http://127.0.0.1/Fit&Fab/signin/signin.php">User</a></h2>
                        </div>
                    </div>
                </div>
            </div>
