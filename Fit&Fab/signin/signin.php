...
header("location: http://127.0.0.1/Fit&Fab/login/indexloggedin.html");
}else{
	?>
	<script>
...
<script src="try.js"></script>
    ...
    <body>
	<video autoplay  poster="assets/img/backgrounds/1.jpg" id="bgvid" loop>
  <!-- WCAG general accessibility recommendation is that media such as background video play through only once. Loop turned on for the purposes of illustration; if removed, the end of the video will fade in the same way created by pressing the "Pause" button  -->

<source src="fit_edit.mp4" type="video/mp4">
</video>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong><a href="../index.html"/>Fit$Fab</a></strong> Login Form</h1>
                  ...
                  <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
							...
							<h3><a href="signinadmin.php">Admin</a></h3>
